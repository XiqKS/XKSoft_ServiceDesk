...
ENTRYPOINT ["powershell", "-Command", "$exists = Test-Path 'C:\\inetpub\\wwwroot\\ssl\\cert.pfx'; if (-not $exists) { .\\win-acme\\wacs.exe --target manual --host xksoftservicedesk.westus2.azurecontainer.io --emailaddress cbpunchy@gmail.com --accepttos --usedefaulttaskuser --certificatestore My --installation iis,script --script 'win-acme/Scripts/ImportRDSFull.ps1' --scriptparameters '{CertThumbprint}' --installationsiteid 1}; C:\\ServiceMonitor.exe w3svc"]
